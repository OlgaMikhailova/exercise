...
public class Users {
    ...
    private By employeeNameValid = By.cssSelector("#systemUser_employeeName_empName[class='formInputText ac_input valid']");
...
//user name
        ...
        driver.findElement(userName).sendKeys("bkkh");
        helper.comparisonActualAndExpected("Should have at least 5 characters", driver.findElement(txtHelpUnderUserName));
        driver.findElement(userName).clear();
